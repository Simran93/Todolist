# Todolist : This app allows to create new to-do lists and all the data is persisted locally on the device using Userdefaults and CoreData with SQLite as a database.
